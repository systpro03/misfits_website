    ...
    <div class="w-full max-w-md relative z-10">
      ...
      <form action="<?= base_url('admin/login'); ?>" method="post"
        ...
        <div>
          ...
          <div class="relative">
            <svg class="w-4 h-4 absolute left-3.5 top-1/2 -translate-y-1/2 text-asphalt-950" fill="none"
        ...
        <div>
          ...
          <div class="relative">
            ...
            <button type="button" id="togglePassword" aria-label="Show password" aria-pressed="false"
              class="absolute right-3.5 top-1/2 -translate-y-1/2 text-asphalt-950 hover:text-ember-600 transition-colors focus:outline-none"
              title="Show password">
