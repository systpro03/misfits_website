          ...
          <div class="w-9 h-9 rounded-xl bg-ember-500/10 text-ember-600 flex items-center justify-center flex-shrink-0">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                d="M5 17h14M6 17l1.2-5.2A2 2 0 019.15 10h5.7a2 2 0 011.95 1.8L18 17M8 10l1.2-3h5.6l1.2 3M7 17v2m10-2v2M8 14h.01M16 14h.01" />
            </svg>
          </div>
          <h1 class="text-lg sm:text-xl font-display font-bold text-asphalt-900 tracking-tight truncate">Rides Directory
          </h1>
        </div>
